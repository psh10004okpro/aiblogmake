...
from app.api.routes import keywords, content, schedule, workflow, notifications, seo, analytics, social_media, conversion, email_marketing, content_repurposing, ab_testing, competitor, marketing_tools, multi_blog
...
app.include_router(marketing_tools.router, prefix=settings.api_v1_prefix)
app.include_router(multi_blog.router, prefix=settings.api_v1_prefix)
